...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        # self.embeddings: word embeddings (num_words, embedding_size)
        # w: word indices (batch_size, n_features)
        # x: output (batch_size, n_features, embedding_size)
        x = torch.index_select(self.embeddings, 0, w.view(-1)).reshape(w.shape[0],-1)
